    ...
    <?php else: ?>
        <div class="col">
            <div class="alert alert-warning text-center">
                <h4>Please Log In to View Your Carrier</h4>
                <p>You need to be logged in to save and view your favorite pets. Please <a href="auth/login.php" class="alert-link">log in</a> or <a href="auth/register.php" class="alert-link">create an account</a>.</p>
            </div>
        </div>
    <?php endif; ?>
</div>
